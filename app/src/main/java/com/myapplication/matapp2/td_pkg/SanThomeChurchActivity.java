...
public class SanThomeChurchActivity extends com.myapplication.matapp2.mat_project_pkg.BaseNavActivity {
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.td_activity_san_thome_church);
        FavHelper.attachDestination(this, "San Thome Church", "Chennai");
        TextView tvAbout = findViewById(R.id.tvAbout);
        String html = getString(R.string.td_san_thome_church_about_text);
        ...
        Button btnMap = findViewById(R.id.btnOpenInMap); btnMap.setOnClickListener(v -> {
            Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("geo:13.0337,80.2780?q=San+Thome+Cathedral+Chennai"));
            if (i.resolveActivity(getPackageManager()) != null) startActivity(i);
            else startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://maps.google.com/?q=San+Thome+Cathedral+Chennai")));
        });
    }
