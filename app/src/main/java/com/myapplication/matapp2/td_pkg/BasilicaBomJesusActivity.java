...
public class BasilicaBomJesusActivity extends com.myapplication.matapp2.mat_project_pkg.BaseNavActivity {
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.td_activity_basilica_bom_jesus);
        FavHelper.attachDestination(this, "Basilica of Bom Jesus", "Goa");
        TextView tvAbout = findViewById(R.id.tvAbout); String html = getString(R.string.td_basilica_bom_jesus_about_text);
        ...
        Button btnMap = findViewById(R.id.btnOpenInMap); btnMap.setOnClickListener(v -> {
            String geo = "geo:15.5009,73.9116?q=Basilica+of+Bom+Jesus,+Old+Goa,+India";
            Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse(geo));
            if (i.resolveActivity(getPackageManager()) != null) startActivity(i);
            else startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://maps.google.com/?q=Basilica+Bom+Jesus+Old+Goa")));
        });
    }
