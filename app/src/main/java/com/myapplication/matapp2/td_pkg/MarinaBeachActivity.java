...
public class MarinaBeachActivity extends com.myapplication.matapp2.mat_project_pkg.BaseNavActivity {
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.td_activity_marina_beach);
        FavHelper.attachDestination(this, "Marina Beach", "Chennai");
        TextView tvAbout = findViewById(R.id.tvAbout);
        String html = getString(R.string.td_marina_beach_about_text);
        ...
        Button btnMap = findViewById(R.id.btnOpenInMap); btnMap.setOnClickListener(v -> {
            Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("geo:13.0500,80.2824?q=Marina+Beach+Chennai"));
            if (i.resolveActivity(getPackageManager()) != null) startActivity(i);
            else startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://maps.google.com/?q=Marina+Beach+Chennai")));
        });
    }
