...
public class PalolemBeachActivity extends com.myapplication.matapp2.mat_project_pkg.BaseNavActivity {
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.td_activity_palolem_beach);
        FavHelper.attachDestination(this, "Palolem Beach", "Goa");
        TextView tvAbout = findViewById(R.id.tvAbout); String html = getString(R.string.td_palolem_beach_about_text);
        ...
        Button btnMap = findViewById(R.id.btnOpenInMap); btnMap.setOnClickListener(v -> {
            String geo = "geo:15.0100,74.0231?q=Palolem+Beach,+Goa,+India";
            Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse(geo));
            if (i.resolveActivity(getPackageManager()) != null) startActivity(i);
            else startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://maps.google.com/?q=Palolem+Beach+Goa")));
        });
    }
