...
public class DhamekStupaActivity extends com.myapplication.matapp2.mat_project_pkg.BaseNavActivity {
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.td_activity_dhamek_stupa);
        FavHelper.attachDestination(this, "Dhamek Stupa", "Varanasi");
        TextView tvAbout = findViewById(R.id.tvAbout);
        String html = getString(R.string.td_dhamek_stupa_about_text);
        ...
        Button btnMap = findViewById(R.id.btnOpenInMap); btnMap.setOnClickListener(v -> {
            Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("geo:25.3793,83.0243?q=Dhamek+Stupa+Sarnath+Varanasi"));
            if (i.resolveActivity(getPackageManager()) != null) startActivity(i);
            else startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://maps.google.com/?q=Dhamek+Stupa+Sarnath")));
        });
    }
