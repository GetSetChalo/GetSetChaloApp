...
public class ItmadUdDaulaActivity extends com.myapplication.matapp2.mat_project_pkg.BaseNavActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.td_activity_itmad_ud_daula);
        FavHelper.attachDestination(this, "Itmad-ud-Daula", "Agra");

        // ── About text with HTML bold spans ──
        TextView tvAbout = findViewById(R.id.tvAbout);
        String aboutHtml = getString(R.string.td_itmad_about_text);
        ...
        btnMap.setOnClickListener(v -> {
            String geoUri = "geo:27.1947,78.0361?q=Itmad-ud-Daula,+Agra,+India";
            Intent mapIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(geoUri));
            if (mapIntent.resolveActivity(getPackageManager()) != null) {
                startActivity(mapIntent);
            } else {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("https://maps.google.com/?q=Itmad-ud-Daula,+Agra,+India"));
