...
public class KapaleeshwararTempleActivity extends com.myapplication.matapp2.mat_project_pkg.BaseNavActivity {
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.td_activity_kapaleeshwarar_temple);
        FavHelper.attachDestination(this, "Kapaleeshwarar Temple", "Chennai");
        TextView tvAbout = findViewById(R.id.tvAbout);
        String html = getString(R.string.td_kapaleeshwarar_temple_about_text);
        ...
        Button btnMap = findViewById(R.id.btnOpenInMap); btnMap.setOnClickListener(v -> {
            Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("geo:13.0336,80.2697?q=Kapaleeshwarar+Temple+Chennai"));
            if (i.resolveActivity(getPackageManager()) != null) startActivity(i);
            else startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://maps.google.com/?q=Kapaleeshwarar+Temple+Chennai")));
        });
    }
