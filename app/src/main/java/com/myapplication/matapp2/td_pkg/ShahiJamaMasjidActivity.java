...
public class ShahiJamaMasjidActivity extends com.myapplication.matapp2.mat_project_pkg.BaseNavActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.td_activity_shahi_jama_masjid);
        FavHelper.attachDestination(this, "Shahi Jama Masjid", "Agra");

        // ── About text with HTML bold spans ──
        TextView tvAbout = findViewById(R.id.tvAbout);
        String aboutHtml = getString(R.string.td_jama_masjid_about_text);
        ...
        btnMap.setOnClickListener(v -> {
            String geoUri = "geo:27.1760,78.0217?q=Jama+Masjid+Agra,+India";
            Intent mapIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(geoUri));
            if (mapIntent.resolveActivity(getPackageManager()) != null) {
                startActivity(mapIntent);
            } else {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("https://maps.google.com/?q=Jama+Masjid+Agra,+India"));
