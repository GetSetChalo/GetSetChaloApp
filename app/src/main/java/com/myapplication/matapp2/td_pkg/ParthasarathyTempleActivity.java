...
public class ParthasarathyTempleActivity extends com.myapplication.matapp2.mat_project_pkg.BaseNavActivity {
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.td_activity_parthasarathy_temple);
        FavHelper.attachDestination(this, "Parthasarathy Temple", "Chennai");
        TextView tvAbout = findViewById(R.id.tvAbout);
        String html = getString(R.string.td_parthasarathy_temple_about_text);
        ...
        Button btnMap = findViewById(R.id.btnOpenInMap); btnMap.setOnClickListener(v -> {
            Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("geo:13.0561,80.2672?q=Parthasarathy+Temple+Triplicane+Chennai"));
            if (i.resolveActivity(getPackageManager()) != null) startActivity(i);
            else startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://maps.google.com/?q=Parthasarathy+Temple+Triplicane+Chennai")));
        });
    }
