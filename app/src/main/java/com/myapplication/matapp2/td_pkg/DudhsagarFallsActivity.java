...
public class DudhsagarFallsActivity extends com.myapplication.matapp2.mat_project_pkg.BaseNavActivity {
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.td_activity_dudhsagar_falls);
        FavHelper.attachDestination(this, "Dudhsagar Falls", "Goa");
        TextView tvAbout = findViewById(R.id.tvAbout); String html = getString(R.string.td_dudhsagar_falls_about_text);
        ...
        Button btnMap = findViewById(R.id.btnOpenInMap); btnMap.setOnClickListener(v -> {
            String geo = "geo:15.3147,74.3144?q=Dudhsagar+Falls,+Goa,+India";
            Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse(geo));
            if (i.resolveActivity(getPackageManager()) != null) startActivity(i);
            else startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://maps.google.com/?q=Dudhsagar+Falls+Goa")));
        });
    }
