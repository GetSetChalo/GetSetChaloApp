...
public class DashashwamedhaGhatActivity extends com.myapplication.matapp2.mat_project_pkg.BaseNavActivity {
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.td_activity_dashashwamedha_ghat);
        FavHelper.attachDestination(this, "Dashashwamedh Ghat", "Varanasi");
        TextView tvAbout = findViewById(R.id.tvAbout);
        String html = getString(R.string.td_dashashwamedha_ghat_about_text);
        ...
        Button btnMap = findViewById(R.id.btnOpenInMap); btnMap.setOnClickListener(v -> {
            Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse("geo:25.3077,83.0108?q=Dashashwamedha+Ghat+Varanasi"));
            if (i.resolveActivity(getPackageManager()) != null) startActivity(i);
            else startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://maps.google.com/?q=Dashashwamedha+Ghat+Varanasi")));
        });
    }
