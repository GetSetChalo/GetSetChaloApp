...
public class TombOfAkbarActivity extends com.myapplication.matapp2.mat_project_pkg.BaseNavActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.td_activity_tomb_of_akbar);
        FavHelper.attachDestination(this, "Tomb of Akbar", "Agra");

        // ── About text with HTML bold spans ──
        TextView tvAbout = findViewById(R.id.tvAbout);
        String aboutHtml = getString(R.string.td_tomb_akbar_about_text);
        ...
        btnMap.setOnClickListener(v -> {
            String geoUri = "geo:27.2419,78.0044?q=Tomb+of+Akbar,+Sikandra,+Agra,+India";
            Intent mapIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(geoUri));
            if (mapIntent.resolveActivity(getPackageManager()) != null) {
                startActivity(mapIntent);
            } else {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW,
                        Uri.parse("https://maps.google.com/?q=Tomb+of+Akbar,+Sikandra,+Agra,+India"));
